<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Eventview.aspx.cs" Inherits="NSS_NC.Web_forms.Eventview" %>
...
<body>
    ...
    <li><a href="#">About</a>
        ...
        <asp:Label ID="Label1" runat="server" Text="Event Details" style="z-index: 1; left: 681px; top: 240px; position: absolute; font-weight: 700; font-size: large"></asp:Label>
		<div style="z-index: 1; left: 9px; top: 264px; position: absolute; height: 26px; width: 1448px; border-bottom-style: solid; border-bottom-color: inherit; border-bottom-width: medium;"></div>
	...
	<li class="lli"><a href="Assign_activity.aspx">Assign activity to Students</a></li>
             ...
             <asp:GridView ID="GridView1" runat="server" style="z-index: 1; left: 285px; top: 312px; position: absolute; height: 152px; width: 929px">
             </asp:GridView>
